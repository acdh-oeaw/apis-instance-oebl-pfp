...
class StandInKontaktMit(
    ...
    """automatically generated class from property with id 164752"""

    _legacy_property_id = 164752
...
class WarSchuelerinVon(
    ...
    """automatically generated class from property with id 164753"""

    _legacy_property_id = 164753
...
class WarVerheiratetMit(
    ...
    """automatically generated class from property with id 164759"""

    _legacy_property_id = 164759
...
class WarElternteilVon(
    ...
    """automatically generated class from property with id 164762"""

    _legacy_property_id = 164762
...
class DissertierteAn(
    ...
    @classmethod
    def name(self) -> str:
        return "dissertierte an [PIO]"

    @classmethod
    def reverse_name(self) -> str:
        return "hatte als Dissertant:in [PIO]"


class HabilitierteSichAn1(
    Relation, VersionMixin, TempTripleGenericAttributes, LegacyDateMixin
):
    """automatically generated class from property with id 167185"""

    _legacy_property_id = 167185
