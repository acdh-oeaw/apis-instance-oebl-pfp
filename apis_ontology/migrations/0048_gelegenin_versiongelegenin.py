...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('apis_ontology', '0047_remove_versionevent_self_contenttype_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', django_interval.fields.FuzzyDateParserField(blank=True, max_length=255, null=True, verbose_name='Start')),
                ('end', django_interval.fields.FuzzyDateParserField(blank=True, max_length=255, null=True, verbose_name='End')),
                ...
                ('review', models.BooleanField(default=False, editable=False, help_text='Should be set to True, if the data record holds up quality standards.')),
                ('status', models.CharField(blank=True, editable=False, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'historical gelegen ins',
