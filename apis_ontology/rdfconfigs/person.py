...
class E21_PersonFromDNBCustom(E21_PersonFromDNB):
    ...
    diedin = Relation(
        ...
        value={"curies": "gndo:placeOfDeath", "obj": "apis_ontology.place"},
    )
    bornin = Relation(
        name="apis_ontology.wurdegeborenin",
        value={"curies": "gndo:placeOfBirth", "obj": "apis_ontology.place"},
    )
...
class E21_PersonFromWikidataCustom(E21_PersonFromWikidata):
    ...
    diedin = Relation(
        name="apis_ontology.starbin",
        value={"curies": "wdt:P20", "obj": "apis_ontology.place"},
    )
    bornin = Relation(
        name="apis_ontology.wurdegeborenin",
        value={"curies": "wdt:P19", "obj": "apis_ontology.place"},
    )
